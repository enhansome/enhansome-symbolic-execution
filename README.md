...
* ***Collection of symbolic execution papers:** [XMUsuny/symbolic-execution-papers](https://github.com/XMUsuny/symbolic-execution-papers) ⭐ 188 | 🐛 6 | 📅 2025-05-16*
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 323 | 🐛 156 | 🌐 OCaml | 📅 2026-09-21 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run Rust code.
...
* [Acteve](https://code.google.com/archive/p/acteve/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,100 | 🐛 346 | 🌐 Java | 📅 2026-09-18 for instrumentation. Originally for Android analysis. Supports [Z3](https://github.com/Z3Prover/z3) ⭐ 12,706 | 🐛 52 | 🌐 C++ | 📅 2026-09-23.
...
* [SWAT](https://github.com/SWAT-project/SWAT) ⭐ 47 | 🐛 11 | 🌐 Java | 📅 2026-09-21 - Loosely coupled dynamic symbolic execution using [ASM](https://asm.ow2.io) for instrumentation, [JavaSMT](https://github.com/sosy-lab/java-smt) ⭐ 243 | 🐛 150 | 🌐 SMT | 📅 2026-09-22 for formula generation and currently [Z3](https://github.com/Z3Prover/z3) ⭐ 12,706 | 🐛 52 | 🌐 C++ | 📅 2026-09-23 as a solver.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 323 | 🐛 156 | 🌐 OCaml | 📅 2026-09-21 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run LLVM code.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 323 | 🐛 156 | 🌐 OCaml | 📅 2026-09-21 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run C code.
...
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,331 | 🐛 76 | 🌐 Python | 📅 2026-09-15 - Symbolic execution tool for verifying properties of Python functions.
...
* [miasm](https://github.com/cea-sec/miasm) ⭐ 3,967 | 🐛 161 | 🌐 Python | 📅 2026-09-21 - Reverse engineering framework. Includes symbolic execution.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 323 | 🐛 156 | 🌐 OCaml | 📅 2026-09-21 - Parallel symbolic execution engine built on WebAssembly (Wasm).
