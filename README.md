...
* [Acteve](https://code.google.com/archive/p/acteve/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,100 | 🐛 346 | 🌐 Java | 📅 2026-09-18 for instrumentation. Originally for Android analysis. Supports [Z3](https://github.com/Z3Prover/z3) ⭐ 12,708 | 🐛 50 | 🌐 C++ | 📅 2026-09-24.
...
* [SWAT](https://github.com/SWAT-project/SWAT) ⭐ 47 | 🐛 11 | 🌐 Java | 📅 2026-09-21 - Loosely coupled dynamic symbolic execution using [ASM](https://asm.ow2.io) for instrumentation, [JavaSMT](https://github.com/sosy-lab/java-smt) ⭐ 243 | 🐛 150 | 🌐 SMT | 📅 2026-09-23 for formula generation and currently [Z3](https://github.com/Z3Prover/z3) ⭐ 12,708 | 🐛 50 | 🌐 C++ | 📅 2026-09-24 as a solver.
...
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,331 | 🐛 78 | 🌐 Python | 📅 2026-09-24 - Symbolic execution tool for verifying properties of Python functions.
