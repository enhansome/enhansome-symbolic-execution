...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 155 | 🌐 OCaml | 📅 2026-09-19 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run Rust code.

### Java

* [LimeTB](http://www.tcs.hut.fi/Software/lime/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,098 | 🐛 346 | 🌐 Java | 📅 2026-09-18 for instrumentation. Supports [Yices](http://yices.csl.sri.com/) and [Boolector](http://fmv.jku.at/boolector/). Concolic execution can be distributed.
* [Acteve](https://code.google.com/archive/p/acteve/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,098 | 🐛 346 | 🌐 Java | 📅 2026-09-18 for instrumentation. Originally for Android analysis. Supports [Z3](https://github.com/Z3Prover/z3) ⭐ 12,703 | 🐛 52 | 🌐 C++ | 📅 2026-09-21.
* [jCUTE](http://osl.cs.illinois.edu/software/jcute/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,098 | 🐛 346 | 🌐 Java | 📅 2026-09-18 for instrumentation. Supports [lp\_solve](http://lpsolve.sourceforge.net/).
...
* [SWAT](https://github.com/SWAT-project/SWAT) ⭐ 47 | 🐛 11 | 🌐 Java | 📅 2026-09-19 - Loosely coupled dynamic symbolic execution using [ASM](https://asm.ow2.io) for instrumentation, [JavaSMT](https://github.com/sosy-lab/java-smt) ⭐ 243 | 🐛 148 | 🌐 SMT | 📅 2026-09-20 for formula generation and currently [Z3](https://github.com/Z3Prover/z3) ⭐ 12,703 | 🐛 52 | 🌐 C++ | 📅 2026-09-21 as a solver.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 155 | 🌐 OCaml | 📅 2026-09-19 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run LLVM code.
* [GenSym](https://github.com/Generative-Program-Analysis/GenSym) ⭐ 150 | 🐛 8 | 🌐 LLVM | 📅 2026-09-18 - A compiler for parallel fork-based symbolic execution.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 155 | 🌐 OCaml | 📅 2026-09-19 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run C code.
...
* [miasm](https://github.com/cea-sec/miasm) ⭐ 3,965 | 🐛 161 | 🌐 Python | 📅 2026-09-19 - Reverse engineering framework. Includes symbolic execution.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 155 | 🌐 OCaml | 📅 2026-09-19 - Parallel symbolic execution engine built on WebAssembly (Wasm).
