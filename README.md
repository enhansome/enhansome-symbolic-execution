...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 156 | 🌐 OCaml | 📅 2026-09-21 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run Rust code.

### Java

* [LimeTB](http://www.tcs.hut.fi/Software/lime/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,099 | 🐛 346 | 🌐 Java | 📅 2026-09-18 for instrumentation. Supports [Yices](http://yices.csl.sri.com/) and [Boolector](http://fmv.jku.at/boolector/). Concolic execution can be distributed.
* [Acteve](https://code.google.com/archive/p/acteve/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,099 | 🐛 346 | 🌐 Java | 📅 2026-09-18 for instrumentation. Originally for Android analysis. Supports [Z3](https://github.com/Z3Prover/z3) ⭐ 12,704 | 🐛 51 | 🌐 C++ | 📅 2026-09-22.
* [jCUTE](http://osl.cs.illinois.edu/software/jcute/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,099 | 🐛 346 | 🌐 Java | 📅 2026-09-18 for instrumentation. Supports [lp\_solve](http://lpsolve.sourceforge.net/).
...
* [SWAT](https://github.com/SWAT-project/SWAT) ⭐ 47 | 🐛 11 | 🌐 Java | 📅 2026-09-21 - Loosely coupled dynamic symbolic execution using [ASM](https://asm.ow2.io) for instrumentation, [JavaSMT](https://github.com/sosy-lab/java-smt) ⭐ 243 | 🐛 150 | 🌐 SMT | 📅 2026-09-21 for formula generation and currently [Z3](https://github.com/Z3Prover/z3) ⭐ 12,704 | 🐛 51 | 🌐 C++ | 📅 2026-09-22 as a solver.
...
* [SymCC](https://github.com/eurecom-s3/symcc) ⭐ 883 | 🐛 58 | 🌐 C++ | 📅 2026-03-16 - A compiler wrapper which embeds symbolic execution into the program during compilation, and an associated run-time support library.
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 156 | 🌐 OCaml | 📅 2026-09-21 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run LLVM code.
* [GenSym](https://github.com/Generative-Program-Analysis/GenSym) ⭐ 150 | 🐛 10 | 🌐 LLVM | 📅 2026-09-22 - A compiler for parallel fork-based symbolic execution.
...
* [VSharp](https://github.com/VSharp-team/VSharp) ⭐ 58 | 🐛 43 | 🌐 C++ | 📅 2025-01-06 - Symbolic execution engine for .NET assemblies.
* [PEX](http://pex4fun.com/About.aspx) - Dynamic symbolic execution tool for .NET.

### C

* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 156 | 🌐 OCaml | 📅 2026-09-21 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run C code.
...
* [Jalangi2](https://github.com/Samsung/jalangi2) ⭐ 498 | 🐛 72 | 🌐 JavaScript | 📅 2026-01-10 - Dynamic analysis framework for JavaScript.
* [SymJS](https://doi.org/10.1145/2635868.2635913) - Automatic symbolic testing of JavaScript web applications.

### Python

* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,330 | 🐛 76 | 🌐 Python | 📅 2026-09-15 - Symbolic execution tool for verifying properties of Python functions.
...
* [miasm](https://github.com/cea-sec/miasm) ⭐ 3,965 | 🐛 161 | 🌐 Python | 📅 2026-09-21 - Reverse engineering framework. Includes symbolic execution.
...
* [BAP](https://github.com/BinaryAnalysisPlatform/bap) ⭐ 2,257 | 🐛 43 | 🌐 OCaml | 📅 2026-05-07 - Binary Analysis Platform provides a framework for writing program analysis tools.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 156 | 🌐 OCaml | 📅 2026-09-21 - Parallel symbolic execution engine built on WebAssembly (Wasm).
...
* [OSS-Sydr-Fuzz](https://github.com/ispras/oss-sydr-fuzz) ⭐ 154 | 🐛 5 | 🌐 C | 📅 2026-09-17 - Hybrid Fuzzing for Open Source Software
