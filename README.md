...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 151 | 🌐 OCaml | 📅 2026-09-09 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run Rust code.

### Java

* [LimeTB](http://www.tcs.hut.fi/Software/lime/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,098 | 🐛 347 | 🌐 Java | 📅 2026-09-11 for instrumentation. Supports [Yices](http://yices.csl.sri.com/) and [Boolector](http://fmv.jku.at/boolector/). Concolic execution can be distributed.
* [Acteve](https://code.google.com/archive/p/acteve/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,098 | 🐛 347 | 🌐 Java | 📅 2026-09-11 for instrumentation. Originally for Android analysis. Supports [Z3](https://github.com/Z3Prover/z3) ⭐ 12,656 | 🐛 50 | 🌐 C++ | 📅 2026-09-12.
* [jCUTE](http://osl.cs.illinois.edu/software/jcute/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,098 | 🐛 347 | 🌐 Java | 📅 2026-09-11 for instrumentation. Supports [lp\_solve](http://lpsolve.sourceforge.net/).
...
* [SWAT](https://github.com/SWAT-project/SWAT) ⭐ 47 | 🐛 11 | 🌐 Java | 📅 2026-09-10 - Loosely coupled dynamic symbolic execution using [ASM](https://asm.ow2.io) for instrumentation, [JavaSMT](https://github.com/sosy-lab/java-smt) ⭐ 242 | 🐛 147 | 🌐 SMT | 📅 2026-09-06 for formula generation and currently [Z3](https://github.com/Z3Prover/z3) ⭐ 12,656 | 🐛 50 | 🌐 C++ | 📅 2026-09-12 as a solver.
...
* [SymCC](https://github.com/eurecom-s3/symcc) ⭐ 881 | 🐛 58 | 🌐 C++ | 📅 2026-03-16 - A compiler wrapper which embeds symbolic execution into the program during compilation, and an associated run-time support library.
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 151 | 🌐 OCaml | 📅 2026-09-09 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run LLVM code.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 151 | 🌐 OCaml | 📅 2026-09-09 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run C code.
...
* [Jalangi2](https://github.com/Samsung/jalangi2) ⭐ 497 | 🐛 72 | 🌐 JavaScript | 📅 2026-01-10 - Dynamic analysis framework for JavaScript.
* [SymJS](https://doi.org/10.1145/2635868.2635913) - Automatic symbolic testing of JavaScript web applications.

### Python

* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,324 | 🐛 78 | 🌐 Python | 📅 2026-09-09 - Symbolic execution tool for verifying properties of Python functions.
...
* [miasm](https://github.com/cea-sec/miasm) ⭐ 3,960 | 🐛 177 | 🌐 Python | 📅 2026-08-24 - Reverse engineering framework. Includes symbolic execution.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 151 | 🌐 OCaml | 📅 2026-09-09 - Parallel symbolic execution engine built on WebAssembly (Wasm).
...
* [OSS-Sydr-Fuzz](https://github.com/ispras/oss-sydr-fuzz) ⭐ 154 | 🐛 6 | 🌐 C | 📅 2026-09-04 - Hybrid Fuzzing for Open Source Software
