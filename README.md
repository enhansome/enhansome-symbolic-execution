...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 323 | 🐛 152 | 🌐 OCaml | 📅 2026-08-20 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run Rust code.
...
* [Acteve](https://code.google.com/archive/p/acteve/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,098 | 🐛 349 | 🌐 Java | 📅 2026-08-17 for instrumentation. Originally for Android analysis. Supports [Z3](https://github.com/Z3Prover/z3) ⭐ 12,584 | 🐛 63 | 🌐 C++ | 📅 2026-08-22.
...
* [SWAT](https://github.com/SWAT-project/SWAT) ⭐ 47 | 🐛 11 | 🌐 Java | 📅 2026-08-21 - Loosely coupled dynamic symbolic execution using [ASM](https://asm.ow2.io) for instrumentation, [JavaSMT](https://github.com/sosy-lab/java-smt) ⭐ 242 | 🐛 146 | 🌐 SMT | 📅 2026-08-16 for formula generation and currently [Z3](https://github.com/Z3Prover/z3) ⭐ 12,584 | 🐛 63 | 🌐 C++ | 📅 2026-08-22 as a solver.
...
* [SymCC](https://github.com/eurecom-s3/symcc) ⭐ 876 | 🐛 58 | 🌐 C++ | 📅 2026-03-16 - A compiler wrapper which embeds symbolic execution into the program during compilation, and an associated run-time support library.
* [Owi](https://github.com/OCamlPro/owi) ⭐ 323 | 🐛 152 | 🌐 OCaml | 📅 2026-08-20 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run LLVM code.
* [GenSym](https://github.com/Generative-Program-Analysis/GenSym) ⭐ 148 | 🐛 8 | 🌐 LLVM | 📅 2026-08-18 - A compiler for parallel fork-based symbolic execution.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 323 | 🐛 152 | 🌐 OCaml | 📅 2026-08-20 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run C code.
...
* [miasm](https://github.com/cea-sec/miasm) ⭐ 3,931 | 🐛 178 | 🌐 Python | 📅 2026-08-10 - Reverse engineering framework. Includes symbolic execution.
...
* [BAP](https://github.com/BinaryAnalysisPlatform/bap) ⭐ 2,250 | 🐛 43 | 🌐 OCaml | 📅 2026-05-07 - Binary Analysis Platform provides a framework for writing program analysis tools.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 323 | 🐛 152 | 🌐 OCaml | 📅 2026-08-20 - Parallel symbolic execution engine built on WebAssembly (Wasm).
...
* [OSS-Sydr-Fuzz](https://github.com/ispras/oss-sydr-fuzz) ⭐ 153 | 🐛 4 | 🌐 C | 📅 2026-08-07 - Hybrid Fuzzing for Open Source Software
