...
* [Acteve](https://code.google.com/archive/p/acteve/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,098 | 🐛 349 | 🌐 Java | 📅 2026-08-17 for instrumentation. Originally for Android analysis. Supports [Z3](https://github.com/Z3Prover/z3) ⭐ 12,574 | 🐛 57 | 🌐 C++ | 📅 2026-08-20.
...
* [SWAT](https://github.com/SWAT-project/SWAT) ⭐ 47 | 🐛 11 | 🌐 Java | 📅 2026-08-18 - Loosely coupled dynamic symbolic execution using [ASM](https://asm.ow2.io) for instrumentation, [JavaSMT](https://github.com/sosy-lab/java-smt) ⭐ 242 | 🐛 146 | 🌐 SMT | 📅 2026-08-16 for formula generation and currently [Z3](https://github.com/Z3Prover/z3) ⭐ 12,574 | 🐛 57 | 🌐 C++ | 📅 2026-08-20 as a solver.
...
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,315 | 🐛 76 | 🌐 Python | 📅 2026-08-19 - Symbolic execution tool for verifying properties of Python functions.
...
* [BinCAT](https://github.com/airbus-seclab/bincat) ⭐ 1,870 | 🐛 18 | 🌐 OCaml | 📅 2025-02-25 - Binary code static analyser, with IDA integration. Performs value and taint analysis, type reconstruction, use-after-free and double-free detection.
