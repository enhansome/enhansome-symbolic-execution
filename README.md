...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 323 | 🐛 152 | 🌐 OCaml | 📅 2026-08-31 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run Rust code.

### Java

* [LimeTB](http://www.tcs.hut.fi/Software/lime/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,098 | 🐛 350 | 🌐 Java | 📅 2026-08-31 for instrumentation. Supports [Yices](http://yices.csl.sri.com/) and [Boolector](http://fmv.jku.at/boolector/). Concolic execution can be distributed.
* [Acteve](https://code.google.com/archive/p/acteve/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,098 | 🐛 350 | 🌐 Java | 📅 2026-08-31 for instrumentation. Originally for Android analysis. Supports [Z3](https://github.com/Z3Prover/z3) ⭐ 12,624 | 🐛 50 | 🌐 C++ | 📅 2026-09-01.
* [jCUTE](http://osl.cs.illinois.edu/software/jcute/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,098 | 🐛 350 | 🌐 Java | 📅 2026-08-31 for instrumentation. Supports [lp\_solve](http://lpsolve.sourceforge.net/).
...
* [SWAT](https://github.com/SWAT-project/SWAT) ⭐ 47 | 🐛 11 | 🌐 Java | 📅 2026-08-22 - Loosely coupled dynamic symbolic execution using [ASM](https://asm.ow2.io) for instrumentation, [JavaSMT](https://github.com/sosy-lab/java-smt) ⭐ 242 | 🐛 147 | 🌐 SMT | 📅 2026-08-30 for formula generation and currently [Z3](https://github.com/Z3Prover/z3) ⭐ 12,624 | 🐛 50 | 🌐 C++ | 📅 2026-09-01 as a solver.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 323 | 🐛 152 | 🌐 OCaml | 📅 2026-08-31 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run LLVM code.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 323 | 🐛 152 | 🌐 OCaml | 📅 2026-08-31 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run C code.
...
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,319 | 🐛 78 | 🌐 Python | 📅 2026-08-31 - Symbolic execution tool for verifying properties of Python functions.
...
* [miasm](https://github.com/cea-sec/miasm) ⭐ 3,945 | 🐛 176 | 🌐 Python | 📅 2026-08-24 - Reverse engineering framework. Includes symbolic execution.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 323 | 🐛 152 | 🌐 OCaml | 📅 2026-08-31 - Parallel symbolic execution engine built on WebAssembly (Wasm).
...
* [OSS-Sydr-Fuzz](https://github.com/ispras/oss-sydr-fuzz) ⭐ 153 | 🐛 4 | 🌐 C | 📅 2026-08-28 - Hybrid Fuzzing for Open Source Software
