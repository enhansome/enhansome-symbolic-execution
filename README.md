...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 319 | 🐛 157 | 🌐 OCaml | 📅 2026-08-10 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run Rust code.
...
* [Acteve](https://code.google.com/archive/p/acteve/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,098 | 🐛 349 | 🌐 Java | 📅 2026-08-10 for instrumentation. Originally for Android analysis. Supports [Z3](https://github.com/Z3Prover/z3) ⭐ 12,561 | 🐛 90 | 🌐 C++ | 📅 2026-08-14.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 319 | 🐛 157 | 🌐 OCaml | 📅 2026-08-10 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run LLVM code.
* [GenSym](https://github.com/Generative-Program-Analysis/GenSym) ⭐ 147 | 🐛 9 | 🌐 Java | 📅 2026-08-03 - A compiler for parallel fork-based symbolic execution.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 319 | 🐛 157 | 🌐 OCaml | 📅 2026-08-10 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run C code.
...
* [miasm](https://github.com/cea-sec/miasm) ⭐ 3,922 | 🐛 176 | 🌐 Python | 📅 2026-08-10 - Reverse engineering framework. Includes symbolic execution.
...
* [BAP](https://github.com/BinaryAnalysisPlatform/bap) ⭐ 2,248 | 🐛 43 | 🌐 OCaml | 📅 2026-05-07 - Binary Analysis Platform provides a framework for writing program analysis tools.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 319 | 🐛 157 | 🌐 OCaml | 📅 2026-08-10 - Parallel symbolic execution engine built on WebAssembly (Wasm).
