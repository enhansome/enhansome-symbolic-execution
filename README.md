...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 152 | 🌐 OCaml | 📅 2026-08-20 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run Rust code.
...
* [Acteve](https://code.google.com/archive/p/acteve/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,098 | 🐛 349 | 🌐 Java | 📅 2026-08-17 for instrumentation. Originally for Android analysis. Supports [Z3](https://github.com/Z3Prover/z3) ⭐ 12,596 | 🐛 55 | 🌐 C++ | 📅 2026-08-24.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 152 | 🌐 OCaml | 📅 2026-08-20 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run LLVM code.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 152 | 🌐 OCaml | 📅 2026-08-20 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run C code.
...
* [Jalangi2](https://github.com/Samsung/jalangi2) ⭐ 494 | 🐛 72 | 🌐 JavaScript | 📅 2026-01-10 - Dynamic analysis framework for JavaScript.
...
* [miasm](https://github.com/cea-sec/miasm) ⭐ 3,935 | 🐛 178 | 🌐 Python | 📅 2026-08-10 - Reverse engineering framework. Includes symbolic execution.
...
* [BAP](https://github.com/BinaryAnalysisPlatform/bap) ⭐ 2,251 | 🐛 43 | 🌐 OCaml | 📅 2026-05-07 - Binary Analysis Platform provides a framework for writing program analysis tools.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 152 | 🌐 OCaml | 📅 2026-08-20 - Parallel symbolic execution engine built on WebAssembly (Wasm).
