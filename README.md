...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 157 | 🌐 OCaml | 📅 2026-09-15 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run Rust code.

### Java

* [LimeTB](http://www.tcs.hut.fi/Software/lime/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,099 | 🐛 348 | 🌐 Java | 📅 2026-09-11 for instrumentation. Supports [Yices](http://yices.csl.sri.com/) and [Boolector](http://fmv.jku.at/boolector/). Concolic execution can be distributed.
* [Acteve](https://code.google.com/archive/p/acteve/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,099 | 🐛 348 | 🌐 Java | 📅 2026-09-11 for instrumentation. Originally for Android analysis. Supports [Z3](https://github.com/Z3Prover/z3) ⭐ 12,673 | 🐛 45 | 🌐 C++ | 📅 2026-09-16.
* [jCUTE](http://osl.cs.illinois.edu/software/jcute/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,099 | 🐛 348 | 🌐 Java | 📅 2026-09-11 for instrumentation. Supports [lp\_solve](http://lpsolve.sourceforge.net/).
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 157 | 🌐 OCaml | 📅 2026-09-15 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run LLVM code.
...
* [VSharp](https://github.com/VSharp-team/VSharp) ⭐ 57 | 🐛 43 | 🌐 C++ | 📅 2025-01-06 - Symbolic execution engine for .NET assemblies.
* [PEX](http://pex4fun.com/About.aspx) - Dynamic symbolic execution tool for .NET.

### C

* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 157 | 🌐 OCaml | 📅 2026-09-15 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run C code.
...
* [miasm](https://github.com/cea-sec/miasm) ⭐ 3,961 | 🐛 184 | 🌐 Python | 📅 2026-08-24 - Reverse engineering framework. Includes symbolic execution.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 157 | 🌐 OCaml | 📅 2026-09-15 - Parallel symbolic execution engine built on WebAssembly (Wasm).
