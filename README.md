...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 151 | 🌐 OCaml | 📅 2026-09-14 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run Rust code.

### Java

* [LimeTB](http://www.tcs.hut.fi/Software/lime/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,099 | 🐛 347 | 🌐 Java | 📅 2026-09-11 for instrumentation. Supports [Yices](http://yices.csl.sri.com/) and [Boolector](http://fmv.jku.at/boolector/). Concolic execution can be distributed.
* [Acteve](https://code.google.com/archive/p/acteve/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,099 | 🐛 347 | 🌐 Java | 📅 2026-09-11 for instrumentation. Originally for Android analysis. Supports [Z3](https://github.com/Z3Prover/z3) ⭐ 12,666 | 🐛 46 | 🌐 C++ | 📅 2026-09-15.
* [jCUTE](http://osl.cs.illinois.edu/software/jcute/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,099 | 🐛 347 | 🌐 Java | 📅 2026-09-11 for instrumentation. Supports [lp\_solve](http://lpsolve.sourceforge.net/).
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 151 | 🌐 OCaml | 📅 2026-09-14 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run LLVM code.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 151 | 🌐 OCaml | 📅 2026-09-14 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run C code.
...
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,327 | 🐛 77 | 🌐 Python | 📅 2026-09-15 - Symbolic execution tool for verifying properties of Python functions.
...
* [miasm](https://github.com/cea-sec/miasm) ⭐ 3,960 | 🐛 182 | 🌐 Python | 📅 2026-08-24 - Reverse engineering framework. Includes symbolic execution.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 151 | 🌐 OCaml | 📅 2026-09-14 - Parallel symbolic execution engine built on WebAssembly (Wasm).
