...
* [Acteve](https://code.google.com/archive/p/acteve/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,098 | 🐛 349 | 🌐 Java | 📅 2026-08-10 for instrumentation. Originally for Android analysis. Supports [Z3](https://github.com/Z3Prover/z3) ⭐ 12,562 | 🐛 73 | 🌐 C++ | 📅 2026-08-16.
...
* [GenSym](https://github.com/Generative-Program-Analysis/GenSym) ⭐ 147 | 🐛 9 | 🌐 Java | 📅 2026-08-15 - A compiler for parallel fork-based symbolic execution.
...
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,315 | 🐛 74 | 🌐 Python | 📅 2026-08-12 - Symbolic execution tool for verifying properties of Python functions.
