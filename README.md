...
* ***Collection of symbolic execution papers:** [XMUsuny/symbolic-execution-papers](https://github.com/XMUsuny/symbolic-execution-papers) ⭐ 187 | 🐛 6 | 📅 2025-05-16*
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 152 | 🌐 OCaml | 📅 2026-09-07 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run Rust code.

### Java

* [LimeTB](http://www.tcs.hut.fi/Software/lime/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,097 | 🐛 346 | 🌐 Java | 📅 2026-09-08 for instrumentation. Supports [Yices](http://yices.csl.sri.com/) and [Boolector](http://fmv.jku.at/boolector/). Concolic execution can be distributed.
* [Acteve](https://code.google.com/archive/p/acteve/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,097 | 🐛 346 | 🌐 Java | 📅 2026-09-08 for instrumentation. Originally for Android analysis. Supports [Z3](https://github.com/Z3Prover/z3) ⭐ 12,655 | 🐛 44 | 🌐 C++ | 📅 2026-09-09.
* [jCUTE](http://osl.cs.illinois.edu/software/jcute/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,097 | 🐛 346 | 🌐 Java | 📅 2026-09-08 for instrumentation. Supports [lp\_solve](http://lpsolve.sourceforge.net/).
...
* [SWAT](https://github.com/SWAT-project/SWAT) ⭐ 47 | 🐛 11 | 🌐 Java | 📅 2026-09-08 - Loosely coupled dynamic symbolic execution using [ASM](https://asm.ow2.io) for instrumentation, [JavaSMT](https://github.com/sosy-lab/java-smt) ⭐ 242 | 🐛 147 | 🌐 SMT | 📅 2026-09-06 for formula generation and currently [Z3](https://github.com/Z3Prover/z3) ⭐ 12,655 | 🐛 44 | 🌐 C++ | 📅 2026-09-09 as a solver.
...
* [SymCC](https://github.com/eurecom-s3/symcc) ⭐ 880 | 🐛 58 | 🌐 C++ | 📅 2026-03-16 - A compiler wrapper which embeds symbolic execution into the program during compilation, and an associated run-time support library.
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 152 | 🌐 OCaml | 📅 2026-09-07 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run LLVM code.
* [GenSym](https://github.com/Generative-Program-Analysis/GenSym) ⭐ 150 | 🐛 9 | 🌐 LLVM | 📅 2026-08-26 - A compiler for parallel fork-based symbolic execution.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 152 | 🌐 OCaml | 📅 2026-09-07 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run C code.
...
* [Jalangi2](https://github.com/Samsung/jalangi2) ⭐ 496 | 🐛 72 | 🌐 JavaScript | 📅 2026-01-10 - Dynamic analysis framework for JavaScript.
* [SymJS](https://doi.org/10.1145/2635868.2635913) - Automatic symbolic testing of JavaScript web applications.

### Python

* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,323 | 🐛 78 | 🌐 Python | 📅 2026-09-01 - Symbolic execution tool for verifying properties of Python functions.
...
* [miasm](https://github.com/cea-sec/miasm) ⭐ 3,958 | 🐛 177 | 🌐 Python | 📅 2026-08-24 - Reverse engineering framework. Includes symbolic execution.
...
* [BAP](https://github.com/BinaryAnalysisPlatform/bap) ⭐ 2,255 | 🐛 43 | 🌐 OCaml | 📅 2026-05-07 - Binary Analysis Platform provides a framework for writing program analysis tools.
* [BinCAT](https://github.com/airbus-seclab/bincat) ⭐ 1,873 | 🐛 18 | 🌐 OCaml | 📅 2025-02-25 - Binary code static analyser, with IDA integration. Performs value and taint analysis, type reconstruction, use-after-free and double-free detection.
* [MAAT](https://github.com/trailofbits/maat) ⭐ 651 | 🐛 32 | 🌐 C++ | 📅 2026-05-22 - Low-level symbolic execution tool, uses Ghidra's p-code.
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 152 | 🌐 OCaml | 📅 2026-09-07 - Parallel symbolic execution engine built on WebAssembly (Wasm).
...
* [OSS-Sydr-Fuzz](https://github.com/ispras/oss-sydr-fuzz) ⭐ 153 | 🐛 6 | 🌐 C | 📅 2026-09-04 - Hybrid Fuzzing for Open Source Software
