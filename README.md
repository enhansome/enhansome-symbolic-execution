...
* [Acteve](https://code.google.com/archive/p/acteve/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,098 | 🐛 347 | 🌐 Java | 📅 2026-09-11 for instrumentation. Originally for Android analysis. Supports [Z3](https://github.com/Z3Prover/z3) ⭐ 12,660 | 🐛 48 | 🌐 C++ | 📅 2026-09-14.
...
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,326 | 🐛 78 | 🌐 Python | 📅 2026-09-09 - Symbolic execution tool for verifying properties of Python functions.
...
* [BAP](https://github.com/BinaryAnalysisPlatform/bap) ⭐ 2,256 | 🐛 43 | 🌐 OCaml | 📅 2026-05-07 - Binary Analysis Platform provides a framework for writing program analysis tools.
