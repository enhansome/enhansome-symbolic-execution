...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 155 | 🌐 OCaml | 📅 2026-09-18 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run Rust code.
...
* [Acteve](https://code.google.com/archive/p/acteve/) - Concolic execution tool that uses [Soot](https://github.com/soot-oss/soot) ⭐ 3,099 | 🐛 346 | 🌐 Java | 📅 2026-09-18 for instrumentation. Originally for Android analysis. Supports [Z3](https://github.com/Z3Prover/z3) ⭐ 12,698 | 🐛 50 | 🌐 C++ | 📅 2026-09-19.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 155 | 🌐 OCaml | 📅 2026-09-18 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run LLVM code.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 155 | 🌐 OCaml | 📅 2026-09-18 - Parallel (dynamic) symbolic execution engine built on WebAssembly (Wasm) that can run C code.
...
* [miasm](https://github.com/cea-sec/miasm) ⭐ 3,963 | 🐛 181 | 🌐 Python | 📅 2026-09-16 - Reverse engineering framework. Includes symbolic execution.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 155 | 🌐 OCaml | 📅 2026-09-18 - Parallel symbolic execution engine built on WebAssembly (Wasm).
